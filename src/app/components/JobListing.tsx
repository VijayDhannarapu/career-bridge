...
export default async function JobListing() {
    ...
    return <div className="mt-6 px-6">
        {
            jobs.map((job) => (
                <div key={job.postId} className="flex flex-wrap max-w-7xl m-auto items-center justify-center  rounded-md p-2 gap-5">
                    <div className="w-[350px] h-[350px] shadow-xl/20 shadow-gray-500 rounded-md border border-gray-300 p-3">
                        ...
                        <div className="flex gap-4 mt-5">
                            ...
                            <p className="p-1 text-center p-1 border border-blue-500 bg-blue-300/40">{job.level}</p>
                        </div>
